function [sector_time] = Corner_Simulation( input_args )
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                ...
                for l=1:numel(K_ARB_F)
                    ...
                    for m=1:numel(K_ARB_R)
                        ...
                        for n=1:numel(Area)
                            ...
                            downforce_coef = Downforce_coef(n);
    ...
    fprintf ('The maximum Fy Combined [N] @ %d Km/h is %d on iteration number %d\n',speed, Fy_combined_opt, iteration);
    ay_opt = Fy_combined_opt / Total_Mass
